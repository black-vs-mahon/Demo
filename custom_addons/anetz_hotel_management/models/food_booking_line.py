...
class FoodBookingLine(models.Model):
    ...
    price_unit = fields.Float(related='food_id.price', string='Price', digits='Product Price', help="The price of the selected food item.")
    tax_ids = fields.Many2many('account.tax', 'hotel_food_order_line_taxes_rel', 'food_id', 'tax_id', string='Taxes',
        help="Default taxes used when selling the food products.", domain=[('type_tax_use', '=', 'sale')])
