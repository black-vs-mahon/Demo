...
class FleetBookingLine(models.Model):
    ...
    tax_ids = fields.Many2many('account.tax', 'hotel_fleet_order_line_taxes_rel', 'fleet_id', 'tax_id', string='Taxes', help="Default taxes used when renting the fleet models.", domain=[('type_tax_use', '=', 'sale')])
