...
class ServiceBookingLine(models.Model):
    ...
    tax_ids = fields.Many2many('account.tax', 'hotel_service_order_line_taxes_rel', 'service_id', 'tax_id',
        related='service_id.taxes_ids', string='Taxes', help="Default taxes used when selling the services.", domain=[('type_tax_use', '=', 'sale')])
